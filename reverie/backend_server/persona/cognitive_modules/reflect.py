...
def reflection_trigger(persona): 
  ...
  # =============================================
  # MOOD-SCALED REFLECTION THRESHOLD (MODIFIED)
  # =============================================
  # Low mood -> lower threshold -> reflects more often (rumination)
  # High mood -> higher threshold -> reflects less often
  # mood ranges from -1.0 to 1.0, so mood_factor ranges from 0.7 to 1.3
  mood_factor = 1.0 - (persona.scratch.mood * 0.3)
  effective_trigger = persona.scratch.importance_trigger_curr * mood_factor

  print (persona.scratch.name, "persona.scratch.importance_trigger_curr::", persona.scratch.importance_trigger_curr)
  print (persona.scratch.importance_trigger_max, "mood_factor::", round(mood_factor, 2))

  if (effective_trigger <= 0 and 
      [] != persona.a_mem.seq_event + persona.a_mem.seq_thought): 
    return True 
  return False
